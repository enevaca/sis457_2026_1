...
public partial class MinervaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Compra__3213E83F10DB1D23");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CompraDe__3213E83F96FA0DD8");
            ...
            entity.HasOne(d => d.IdCompraNavigation).WithMany(p => p.CompraDetalle)
                .HasForeignKey(d => d.IdCompra)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_CompraDetalle_Compra");

            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.CompraDetalle)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Empleado__3213E83FF3820CCA");

            entity.HasIndex(e => e.CedulaIdentidad, "UQ__Empleado__9FE1EA24B379E326").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Producto__3213E83F6F623027");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Proveedo__3213E83FA7DECD2E");

            entity.HasIndex(e => e.RazonSocial, "UQ__Proveedo__17BADCA0487FC585").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UnidadMe__3213E83FC0142C32");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Usuario__3213E83FB9C534E5");

            entity.HasIndex(e => e.Usuario1, "UQ__Usuario__9AFF8FC60844E5BC").IsUnique();
